...
void Move (){
  int x;
  int y;
  if ((V1 > 1470 & V1 < 1515) & (V2 > 1470 & V2 < 1515)){
    TR.writeMicroseconds(1500);
    TL.writeMicroseconds(1500);
  }
  else if ((V1 > 1470 & V1 < 1515) & (V2 < 1470 || V2 > 1515)) {
    TR.writeMicroseconds(map(V2, 988, 2012, 1100, 1900));
    TL.writeMicroseconds(map(V2, 988, 2012, 1100, 1900));
  }
  else if ((V1 < 1470) & (V2 > 1470 & V2 < 1515)) {
    TR.writeMicroseconds(map(V1, 988, 2012, 1100, 1900));
    TL.writeMicroseconds(map(V1, 988, 2012, 1900, 1100));
  }
  else if ((V1 > 1515) & (V2 > 1470 & V2 < 1515)) {
    TL.writeMicroseconds(map(V1, 988, 2012, 1100, 1900));
    TR.writeMicroseconds(map(V1, 988, 2012, 1900, 1100));
  }
  else if ((V1 < 1470) & (V2 < 1470 || V2 > 1515)) {
